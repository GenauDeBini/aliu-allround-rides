...
import sprinterSide from "@/assets/sprinter-side.jpg";
    ...
    <header className="sticky top-0 z-50 border-b border-border/40 bg-background/80 backdrop-blur-xl">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 sm:px-6">
        ...
        <nav className="hidden items-center gap-8 text-sm font-medium md:flex">
          ...
          <a href="#sprinter" className="text-muted-foreground transition hover:text-foreground">Sprinter</a>
          <a href="#preise" className="text-muted-foreground transition hover:text-foreground">Preise</a>
      ...
      <div className="relative mx-auto grid max-w-7xl gap-10 px-4 pb-20 pt-16 sm:px-6 md:grid-cols-2 md:gap-6 md:pb-32 md:pt-24">
        ...
        >
          ...
          <p className="mt-6 max-w-md text-lg text-muted-foreground">
            ...
            ab <span className="font-semibold text-foreground">CHF 60.–</span> inkl. 50 km & Vollkasko.
          </p>
        ...
        >
          ...
          />
          <div className="absolute -bottom-5 -left-5 hidden rounded-2xl border border-primary/30 bg-card/90 px-5 py-4 backdrop-blur sm:block">
            <div className="text-[10px] font-semibold uppercase tracking-widest text-primary">
              ab CHF
            </div>
            <div className="font-display text-4xl text-foreground">60.–</div>
            <div className="text-xs text-muted-foreground">1–3 Stunden mieten</div>
          </div>
        </motion.div>
      </div>
    </section>
    ...
    <section id="sprinter" className="relative overflow-hidden border-y border-border/40 bg-card/30">
      ...
      <div className="relative mx-auto grid max-w-7xl gap-12 px-4 py-24 sm:px-6 md:grid-cols-2">
        ...
        <div className="grid gap-4">
          <img
            src={sprinterSide}
            alt="Mercedes Sprinter Seitenansicht"
            width={1280}
            height={960}
            loading="lazy"
          ...
          <img
            ...
            alt="Mercedes Sprinter Innenraum mit Cockpit"
            width={1280}
            height={960}
            loading="lazy"
            className="aspect-[4/3] w-full rounded-2xl border border-border object-cover shadow-elegant"
